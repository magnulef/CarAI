...
public class RewardGates extends GameObject {
    ...
    static {
        ...
        LINES.add(new Line(9,500, 805, 500, 965));
        LINES.add(new Line(10,350, 805, 350, 965));
        LINES.add(new Line(11,180, 805, 180, 965));
        ...
        LINES.add(new Line(16,705, 800, 845, 800));
        LINES.add(new Line(17,705, 650, 845, 650));
        LINES.add(new Line(18,705, 525, 845, 525));
        ...
        LINES.add(new Line(26,180, 15, 180, 145));
        LINES.add(new Line(27,350, 15, 350, 245));
        LINES.add(new Line(28,500, 185, 500, 245));
